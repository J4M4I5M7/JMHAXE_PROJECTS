...
::ind::structs::geom::primitives::IntPoint_obj::__register();
...
::bas::refactor::ProtoTapSprite_obj::__register();
::bas::consts::openfl::geom::PointZZ_obj::__register();
...
::bas::consts::openfl::geom::PointZZ_obj::__boot();
::bas::refactor::ProtoTapSprite_obj::__boot();
...
::ind::structs::geom::primitives::IntPoint_obj::__boot();
