...
@:access(openfl.Lib) class ApplicationMain {
	...
	public static function embed (elementName:String, width:Null<Int> = null, height:Null<Int> = null, background:String = null) {
		...
		//loaders.set("img/BLINK_EYES_01.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/BLINK_EYES_02.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/BLINK_EYES_03.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/BODY_01.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/BODY_02.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/IDLE_EYES_01.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/IDLE_EYES_02.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/MOUTH_01.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/MOUTH_02.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/MOUTH_03.PNG", loader);
		total ++;
		...
		image.src = id;
		//var loader:Loader = new Loader();
		//loaders.set("img/PreviewImage150x150.png", loader);
		total ++;
