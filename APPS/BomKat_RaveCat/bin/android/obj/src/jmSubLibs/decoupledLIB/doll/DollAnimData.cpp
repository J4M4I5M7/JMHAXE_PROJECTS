...
{
HX_STACK_FRAME("jmSubLibs.decoupledLIB.doll.DollAnimData","new",0x15c1a892,"jmSubLibs.decoupledLIB.doll.DollAnimData.new","jmSubLibs/decoupledLIB/doll/DollAnimData.hx",7,0x312f7b9d)
HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.decoupledLIB.doll.DollAnimData"), hx::TCanCast< DollAnimData_obj> ,sStaticFields,sMemberFields,
