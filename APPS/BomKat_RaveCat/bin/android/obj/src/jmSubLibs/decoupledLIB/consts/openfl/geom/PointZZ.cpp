...
{
HX_STACK_FRAME("jmSubLibs.decoupledLIB.consts.openfl.geom.PointZZ","new",0xa7612979,"jmSubLibs.decoupledLIB.consts.openfl.geom.PointZZ.new","jmSubLibs/decoupledLIB/consts/openfl/geom/PointZZ.hx",14,0xa93d15d8)
HX_STACK_THIS(this)
{
}
;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.decoupledLIB.consts.openfl.geom.PointZZ"), hx::TCanCast< PointZZ_obj> ,sStaticFields,sMemberFields,
