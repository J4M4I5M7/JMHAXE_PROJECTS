...
::jmSubLibs::genLIB::decoupledLIB::systems::spriteBased::doll::helpers::DollAnimData_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::spriteBased::doll::components::BMDollSprite_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::spriteBased::doll::ChibiSpace_obj::__register();
...
::jmSubLibs::genLIB::decoupledLIB::systems::spriteBased::doll::ChibiSpace_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::spriteBased::doll::components::BMDollSprite_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::spriteBased::doll::helpers::DollAnimData_obj::__boot();
