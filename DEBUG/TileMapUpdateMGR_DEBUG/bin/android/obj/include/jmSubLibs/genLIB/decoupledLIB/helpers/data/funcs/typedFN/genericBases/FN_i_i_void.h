...
#define INCLUDED_jmSubLibs_genLIB_decoupledLIB_helpers_data_funcs_typedFN_genericBases_FN_i_i_void
...
class HXCPP_CLASS_ATTRIBUTES  FN_i_i_void_obj : public ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::TypedFunctionBase_obj{
	public:
		typedef ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::TypedFunctionBase_obj super;
		typedef FN_i_i_void_obj OBJ_;
		FN_i_i_void_obj();
		Void __construct();
	...
	public:
		...
		static hx::ObjectPtr< FN_i_i_void_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("FN_i_i_void"); }
...
#endif /* INCLUDED_jmSubLibs_genLIB_decoupledLIB_helpers_data_funcs_typedFN_genericBases_FN_i_i_void */ 
