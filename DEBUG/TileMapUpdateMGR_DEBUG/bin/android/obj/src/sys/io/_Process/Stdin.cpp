...
{
HX_STACK_FRAME("sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/_std/sys/io/Process.hx",29,0x4652e940)
HX_STACK_THIS(this)
HX_STACK_ARG(p,"p")
{
	HX_STACK_LINE(30)
