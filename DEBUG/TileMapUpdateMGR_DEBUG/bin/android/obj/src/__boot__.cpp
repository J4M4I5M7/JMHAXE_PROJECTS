...
::jmSubLibs::genLIB::freeBinaryLIB::structs::glue::IntString_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::glue::IntFloat_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::glue::IntBool_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::geom::primitives::PointPair_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::geom::primitives::NumPoint_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::geom::primitives::IntPoint_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::UpdateableFloatAnimHelperXY_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::UpdateableFloatAnimHelper_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::FloatAnimHelperXY_obj::__register();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::FloatAnimHelper_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::funcs::BFPU_MakeRectangularGradient_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::BitmapFillPatternUtil_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::utils::staticUtils::builtInTypes::vector::VectorUtil_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::render::TileMapViewPortRenderEr_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::render::TileChunkFetcher_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::render::TCF_Cache_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::helpers::TMR_BoundSYS_FUNCS_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::helpers::ScrollZoomAnimHelper_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::debug::TileMapUpdateMGR_Debugger_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::TileMapUpdateMGR_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapDims::helpers::TileMapDimsSetterHelper_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapDims::TileMapDims_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapActions::helpers::TileMapActionsInputSurfaceLinker_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapActions::components::TMAC_BoundActionsFUNCS_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapActions::TileMapActionsContainer_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::structs::glue::BitMapBool_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_f_void_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_X0Y0X1Y1_VOID_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_VOID_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_i_i_void_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_i_i_bitmapBool_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_VOID_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_INT_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_int_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_BOOL_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_bool_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_void_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::TypedFunctionBase_obj::__register();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::consts::openfl::geom::PointZZ_obj::__register();
::openfl::geom::Point_obj::__register();
::jmSubLibs::expLIB::haxePhoneLIB::staticUtils::ScreenSizeUtil_obj::__register();
::jmSubLibs::UNIT_TEST_obj::__register();
::jmSubLibs::EU_obj::__register();
...
::com::kircode::debug::FPS_Mem_obj::__register();
...
::com::kircode::debug::FPS_Mem_obj::__boot();
...
::jmSubLibs::EU_obj::__boot();
::jmSubLibs::UNIT_TEST_obj::__boot();
::jmSubLibs::expLIB::haxePhoneLIB::staticUtils::ScreenSizeUtil_obj::__boot();
::openfl::geom::Point_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::consts::openfl::geom::PointZZ_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::TypedFunctionBase_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_void_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_bool_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_BOOL_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_int_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_INT_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_VOID_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_i_i_bitmapBool_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_i_i_i_i_void_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_VOID_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_X0Y0X1Y1_VOID_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::genericBases::FN_f_void_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::helpers::data::structs::glue::BitMapBool_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapActions::TileMapActionsContainer_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapActions::components::TMAC_BoundActionsFUNCS_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapActions::helpers::TileMapActionsInputSurfaceLinker_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapDims::TileMapDims_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::helpers::mapDims::helpers::TileMapDimsSetterHelper_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::TileMapUpdateMGR_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::debug::TileMapUpdateMGR_Debugger_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::helpers::ScrollZoomAnimHelper_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::helpers::TMR_BoundSYS_FUNCS_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::render::TCF_Cache_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::render::TileChunkFetcher_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::render::TileMapViewPortRenderEr_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::utils::staticUtils::builtInTypes::vector::VectorUtil_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::BitmapFillPatternUtil_obj::__boot();
::jmSubLibs::genLIB::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::funcs::BFPU_MakeRectangularGradient_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::FloatAnimHelper_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::FloatAnimHelperXY_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::UpdateableFloatAnimHelper_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::anim::UpdateableFloatAnimHelperXY_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::geom::primitives::IntPoint_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::geom::primitives::NumPoint_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::geom::primitives::PointPair_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::glue::IntBool_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::glue::IntFloat_obj::__boot();
::jmSubLibs::genLIB::freeBinaryLIB::structs::glue::IntString_obj::__boot();
