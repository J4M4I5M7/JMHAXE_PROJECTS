...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.funcs.typedFN.genericBases.FN_i_i_i_i_bitmapBool","new",0x17445171,"jmSubLibs.genLIB.decoupledLIB.helpers.funcs.typedFN.genericBases.FN_i_i_i_i_bitmapBool.new","jmSubLibs/genLIB/decoupledLIB/helpers/funcs/typedFN/genericBases/FN_i_i_i_i_bitmapBool.hx",19,0x7a13d43c)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(19)
	super::__construct();
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.funcs.typedFN.genericBases.FN_i_i_i_i_bitmapBool"), hx::TCanCast< FN_i_i_i_i_bitmapBool_obj> ,sStaticFields,sMemberFields,
