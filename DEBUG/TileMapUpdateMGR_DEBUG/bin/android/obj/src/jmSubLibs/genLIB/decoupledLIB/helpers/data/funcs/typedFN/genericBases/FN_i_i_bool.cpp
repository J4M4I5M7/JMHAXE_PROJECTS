...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.genericBases.FN_i_i_bool","new",0x64aef59c,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.genericBases.FN_i_i_bool.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/genericBases/FN_i_i_bool.hx",17,0x2a91e594)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(17)
	super::__construct();
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.genericBases.FN_i_i_bool"), hx::TCanCast< FN_i_i_bool_obj> ,sStaticFields,sMemberFields,
