...
#ifndef INCLUDED_jmSubLibs_genLIB_decoupledLIB_helpers_consts_openfl_geom_PointZZ
#include <jmSubLibs/genLIB/decoupledLIB/helpers/consts/openfl/geom/PointZZ.h>
#endif
...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.consts.openfl.geom.PointZZ","new",0xd4a3a94f,"jmSubLibs.genLIB.decoupledLIB.helpers.consts.openfl.geom.PointZZ.new","jmSubLibs/genLIB/decoupledLIB/helpers/consts/openfl/geom/PointZZ.hx",14,0x2aa20600)
HX_STACK_THIS(this)
{
}
;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.consts.openfl.geom.PointZZ"), hx::TCanCast< PointZZ_obj> ,sStaticFields,sMemberFields,
