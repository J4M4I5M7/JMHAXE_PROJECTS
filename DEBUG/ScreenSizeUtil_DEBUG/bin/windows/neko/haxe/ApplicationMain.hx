...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JMIM", "ScreenSizeUtilDEBUG", "ScreenSizeUtilDEBUG", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "ScreenSizeUtil_DEBUG", null, { width: 800, height: 480 });
