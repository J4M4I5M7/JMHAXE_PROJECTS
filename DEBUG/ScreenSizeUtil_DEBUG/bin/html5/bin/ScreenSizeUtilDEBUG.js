...
Main.prototype = $extend(openfl.display.Sprite.prototype,{
	...
	,init: function() {
		...
		this.inited = true;
		jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.debugVisualTest(this);
	}
	,added: function(e) {
...
jmSubLibs.decoupledLIB.utils = {};
jmSubLibs.decoupledLIB.utils.staticUtils = {};
jmSubLibs.decoupledLIB.utils.staticUtils.graphics = {};
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap = {};
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill = {};
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil = function() {
};
$hxClasses["jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil"] = jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil;
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.__name__ = ["jmSubLibs","decoupledLIB","utils","staticUtils","graphics","bitmap","fill","BitmapFillPatternUtil"];
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient = function(inBm,centerColor,edgeColor,clearBitmapFirst) {
	if(clearBitmapFirst == null) clearBitmapFirst = true;
	jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.func(inBm,centerColor,edgeColor,clearBitmapFirst);
};
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.prototype = {
	__class__: jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil
};
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs = {};
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient = function() {
};
$hxClasses["jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient"] = jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient;
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.__name__ = ["jmSubLibs","decoupledLIB","utils","staticUtils","graphics","bitmap","fill","funcs","BFPU_MakeRectangularGradient"];
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.func = function(inBm,centerColor,edgeColor,clearBitmapFirst) {
	if(clearBitmapFirst == null) clearBitmapFirst = true;
...
jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.prototype = {
	__class__: jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient
};
jmSubLibs.haxePhoneLIB = {};
jmSubLibs.haxePhoneLIB.staticUtils = {};
jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil = function() {
};
$hxClasses["jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil"] = jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil;
jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.__name__ = ["jmSubLibs","haxePhoneLIB","staticUtils","ScreenSizeUtil"];
jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelWid = function() {
	var op = openfl.Lib.current.stage.stageWidth;
	return op;
};
jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelHig = function() {
	var op = openfl.Lib.current.stage.stageHeight;
	return op;
};
jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.debugVisualTest = function(inMain) {
	var w = jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelWid();
	var h = jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelHig();
	var buf = new openfl.display.BitmapData(w,h,true,-65536);
	jmSubLibs.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient(buf,-65536,-16711936,true);
	var buf_vis = new openfl.display.Bitmap();
	buf_vis.bitmapData = buf;
	inMain.addChild(buf_vis);
};
jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil.prototype = {
	__class__: jmSubLibs.haxePhoneLIB.staticUtils.ScreenSizeUtil
};
var js = {};
js.Boot = function() { };
