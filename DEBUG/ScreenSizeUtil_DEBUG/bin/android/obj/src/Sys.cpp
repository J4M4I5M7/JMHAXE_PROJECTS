...
{
		HX_STACK_FRAME("Sys","print",0x483745ec,"Sys.print","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/_std/Sys.hx",25,0x44259947)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(25)
		::__hxcpp_print(v);
	}
...
{
		HX_STACK_FRAME("Sys","println",0x3905f76e,"Sys.println","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/_std/Sys.hx",28,0x44259947)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(29)
		::Sys_obj::print(v);
		HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("Sys","sleep",0xfe70aad6,"Sys.sleep","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/_std/Sys.hx",65,0x44259947)
...
{
		HX_STACK_FRAME("Sys","exit",0xed97463f,"Sys.exit","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/_std/Sys.hx",108,0x44259947)
