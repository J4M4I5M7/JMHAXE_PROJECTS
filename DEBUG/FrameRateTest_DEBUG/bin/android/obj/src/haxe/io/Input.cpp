...
int Input_obj::readByte( ){
	HX_STACK_FRAME("haxe.io.Input","readByte",0x4de8a3c2,"haxe.io.Input.readByte","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",37,0x75871ddd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(39)
...
{
		HX_STACK_FRAME("haxe.io.Input","close",0xfc421af4,"haxe.io.Input.close","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",67,0x75871ddd)
		HX_STACK_THIS(this)
	}
return null();
}
...
::String Input_obj::readLine( ){
	HX_STACK_FRAME("haxe.io.Input","readLine",0x54789cae,"haxe.io.Input.readLine","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/haxe/io/Input.hx",127,0x75871ddd)
	HX_STACK_THIS(this)
	HX_STACK_LINE(128)
