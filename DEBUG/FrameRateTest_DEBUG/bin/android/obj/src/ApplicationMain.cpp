...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(19)
		::openfl::Lib_obj::setPackage(HX_CSTRING("JMIM"),HX_CSTRING("FrameRateTestDEBUG"),HX_CSTRING("com.FrameRateTestDEBUG"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(35)
		::openfl::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::openfl::Lib_obj::HARDWARE) | int(::openfl::Lib_obj::ALLOW_SHADERS))) | int(::openfl::Lib_obj::REQUIRE_SHADERS))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int(::openfl::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("FrameRateTest_DEBUG"),null(),null());
	}
return null();
}
