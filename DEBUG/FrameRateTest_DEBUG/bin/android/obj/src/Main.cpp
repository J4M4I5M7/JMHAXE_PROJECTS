...
{
HX_STACK_FRAME("Main","new",0x6616a5cb,"Main.new","Main.hx",48,0x087e5c05)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(49)
	super::__construct();
...
{
		HX_STACK_FRAME("Main","resize",0x39257969,"Main.resize","Main.hx",21,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(21)
		if ((!(this->inited))){
...
Void Main_obj::init( ){
{
		...
		this->inited = true;
		HX_STACK_LINE(30)
		this->set_opaqueBackground((int)16776960);
		HX_STACK_LINE(33)
		::com::kircode::debug::FPS_Mem fps = ::com::kircode::debug::FPS_Mem_obj::__new(null(),null(),null());		HX_STACK_VAR(fps,"fps");
		HX_STACK_LINE(34)
		this->addChild(fps);
	}
return null();
...
{
		HX_STACK_FRAME("Main","added",0x98771aeb,"Main.added","Main.hx",54,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(e,"e")
		HX_STACK_LINE(55)
...
Void Main_obj::main( ){
{
		HX_STACK_FRAME("Main","main",0xed0e206e,"Main.main","Main.hx",65,0x087e5c05)
		HX_STACK_LINE(67)
