...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JMIM", "GridTapLinkerDEBUG", "com.GridTapLinkerDEBUG", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "com.GridTapLinker_DEBUG", null, { width: 800, height: 480 });
