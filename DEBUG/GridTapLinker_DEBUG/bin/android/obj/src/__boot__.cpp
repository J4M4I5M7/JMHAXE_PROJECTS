...
::jmSubLibs::haxePhoneLIB::staticUtils::ScreenSizeUtil_obj::__register();
::jmSubLibs::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::funcs::BFPU_MakeRectangularGradient_obj::__register();
::jmSubLibs::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::BitmapFillPatternUtil_obj::__register();
::jmSubLibs::decoupledLIB::systems::tileBased::frameWork::gridTap::GridTapLinker_obj::__register();
::jmSubLibs::decoupledLIB::helpers::funcs::typedFN::FN_TXTY_VOID_obj::__register();
::jmSubLibs::decoupledLIB::helpers::funcs::TypedFunctionBase_obj::__register();
...
::jmSubLibs::decoupledLIB::helpers::funcs::TypedFunctionBase_obj::__boot();
::jmSubLibs::decoupledLIB::helpers::funcs::typedFN::FN_TXTY_VOID_obj::__boot();
::jmSubLibs::decoupledLIB::systems::tileBased::frameWork::gridTap::GridTapLinker_obj::__boot();
::jmSubLibs::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::BitmapFillPatternUtil_obj::__boot();
::jmSubLibs::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::funcs::BFPU_MakeRectangularGradient_obj::__boot();
::jmSubLibs::haxePhoneLIB::staticUtils::ScreenSizeUtil_obj::__boot();
