...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JMIM", "TileMapUpdateMGR", "com.TileMapUpdateMGR", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "com.TileMapUpdateMGR", null, { width: 800, height: 480 });
