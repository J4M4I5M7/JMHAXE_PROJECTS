...
#define INCLUDED_jmSubLibs_genLIB_decoupledLIB_helpers_funcs_typedFN_genericBases_FN_i_i_void
...
class HXCPP_CLASS_ATTRIBUTES  FN_i_i_void_obj : public ::jmSubLibs::genLIB::decoupledLIB::helpers::funcs::TypedFunctionBase_obj{
	public:
...
#endif /* INCLUDED_jmSubLibs_genLIB_decoupledLIB_helpers_funcs_typedFN_genericBases_FN_i_i_void */ 
