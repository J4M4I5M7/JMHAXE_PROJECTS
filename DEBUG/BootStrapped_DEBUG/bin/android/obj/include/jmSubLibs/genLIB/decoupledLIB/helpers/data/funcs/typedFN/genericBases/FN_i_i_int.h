...
#define INCLUDED_jmSubLibs_genLIB_decoupledLIB_helpers_data_funcs_typedFN_genericBases_FN_i_i_int
...
class HXCPP_CLASS_ATTRIBUTES  FN_i_i_int_obj : public ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::TypedFunctionBase_obj{
	public:
		typedef ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::TypedFunctionBase_obj super;
		typedef FN_i_i_int_obj OBJ_;
		FN_i_i_int_obj();
		Void __construct();
	...
	public:
		...
		static hx::ObjectPtr< FN_i_i_int_obj > __new();
		...
		::String __ToString() const { return HX_CSTRING("FN_i_i_int"); }
...
#endif /* INCLUDED_jmSubLibs_genLIB_decoupledLIB_helpers_data_funcs_typedFN_genericBases_FN_i_i_int */ 
