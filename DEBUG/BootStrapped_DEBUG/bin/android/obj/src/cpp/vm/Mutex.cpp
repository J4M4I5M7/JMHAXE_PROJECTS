...
{
HX_STACK_FRAME("cpp.vm.Mutex","new",0xabb3ca05,"cpp.vm.Mutex.new","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/vm/Mutex.hx",27,0x67b8b6e2)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(28)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","acquire",0xc3527bfb,"cpp.vm.Mutex.acquire","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/vm/Mutex.hx",31,0x67b8b6e2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(31)
...
{
		HX_STACK_FRAME("cpp.vm.Mutex","release",0x675bb5ec,"cpp.vm.Mutex.release","C:\\DEV\\Programs\\Haxe\\HaxeToolKit\\haxe\\std/cpp/vm/Mutex.hx",37,0x67b8b6e2)
		HX_STACK_THIS(this)
		HX_STACK_LINE(37)
