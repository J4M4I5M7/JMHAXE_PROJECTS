...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_VOID_VOID","new",0xc13fedda,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_VOID_VOID.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_VOID_VOID.hx",13,0x1f211cd5)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(13)
	super::__construct();
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID FN_VOID_VOID_obj::make( Dynamic inFunc,::String inName){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_VOID_VOID","make",0x5603e734,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_VOID_VOID.make","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_VOID_VOID.hx",22,0x1f211cd5)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_LINE(24)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID op = ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID_obj::__new();		HX_STACK_VAR(op,"op");
	HX_STACK_LINE(25)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID_obj::init(inFunc,inName,op);
	HX_STACK_LINE(26)
	return op;
}
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID FN_VOID_VOID_obj::init( Dynamic inFunc,::String inName,::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_VOID_VOID op){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_VOID_VOID","init",0x5368e856,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_VOID_VOID.init","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_VOID_VOID.hx",34,0x1f211cd5)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_ARG(op,"op")
	HX_STACK_LINE(35)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_VOID_VOID"), hx::TCanCast< FN_VOID_VOID_obj> ,sStaticFields,sMemberFields,
