...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_PXPY_VOID","new",0xbaa89b7d,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_PXPY_VOID.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_PXPY_VOID.hx",14,0xac4d3492)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(14)
	super::__construct();
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID FN_PXPY_VOID_obj::make( Dynamic inFunc,::String inName){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_PXPY_VOID","make",0x98332831,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_PXPY_VOID.make","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_PXPY_VOID.hx",21,0xac4d3492)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_LINE(23)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID op = ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID_obj::__new();		HX_STACK_VAR(op,"op");
	HX_STACK_LINE(26)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID_obj::init(inFunc,inName,op);
	HX_STACK_LINE(29)
	return op;
}
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID FN_PXPY_VOID_obj::init( Dynamic inFunc,::String inName,::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_PXPY_VOID op){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_PXPY_VOID","init",0x95982953,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_PXPY_VOID.init","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_PXPY_VOID.hx",35,0xac4d3492)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_ARG(op,"op")
	HX_STACK_LINE(36)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_PXPY_VOID"), hx::TCanCast< FN_PXPY_VOID_obj> ,sStaticFields,sMemberFields,
