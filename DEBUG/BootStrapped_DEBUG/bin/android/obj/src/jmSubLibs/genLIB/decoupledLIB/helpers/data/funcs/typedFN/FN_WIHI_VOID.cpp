...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_WIHI_VOID","new",0xbd19c5bb,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_WIHI_VOID.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_WIHI_VOID.hx",16,0xba169c14)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(16)
	super::__construct();
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID FN_WIHI_VOID_obj::make( Dynamic inFunc,::String inName){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_WIHI_VOID","make",0xb8c6f433,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_WIHI_VOID.make","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_WIHI_VOID.hx",26,0xba169c14)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_LINE(30)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID op = ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID_obj::__new();		HX_STACK_VAR(op,"op");
	HX_STACK_LINE(33)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID_obj::init(inFunc,inName,op);
	HX_STACK_LINE(36)
	return op;
}
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID FN_WIHI_VOID_obj::init( Dynamic inFunc,::String inName,::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_WIHI_VOID op){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_WIHI_VOID","init",0xb62bf555,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_WIHI_VOID.init","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_WIHI_VOID.hx",44,0xba169c14)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_ARG(op,"op")
	HX_STACK_LINE(45)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_WIHI_VOID"), hx::TCanCast< FN_WIHI_VOID_obj> ,sStaticFields,sMemberFields,
