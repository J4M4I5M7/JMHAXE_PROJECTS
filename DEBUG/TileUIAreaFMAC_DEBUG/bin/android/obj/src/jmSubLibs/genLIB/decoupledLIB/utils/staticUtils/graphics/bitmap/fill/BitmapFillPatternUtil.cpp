...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil","new",0xe6fddba1,"jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.new","jmSubLibs/genLIB/decoupledLIB/utils/staticUtils/graphics/bitmap/fill/BitmapFillPatternUtil.hx",15,0x3057ee4d)
HX_STACK_THIS(this)
{
}
;
...
bool clearBitmapFirst = __o_clearBitmapFirst.Default(true);
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil","makeRectangularGradient",0xbb32eec1,"jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient","jmSubLibs/genLIB/decoupledLIB/utils/staticUtils/graphics/bitmap/fill/BitmapFillPatternUtil.hx",24,0x3057ee4d)
...
{
		HX_STACK_LINE(24)
		::jmSubLibs::genLIB::decoupledLIB::utils::staticUtils::graphics::bitmap::fill::funcs::BFPU_MakeRectangularGradient_obj::func(inBm,centerColor,edgeColor,clearBitmapFirst);
	}
return null();
}
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil"), hx::TCanCast< BitmapFillPatternUtil_obj> ,sStaticFields,sMemberFields,
