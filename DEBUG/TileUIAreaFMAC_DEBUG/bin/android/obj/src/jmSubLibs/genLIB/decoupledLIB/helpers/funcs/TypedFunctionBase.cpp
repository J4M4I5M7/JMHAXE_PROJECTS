...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.funcs.TypedFunctionBase","new",0xe2776487,"jmSubLibs.genLIB.decoupledLIB.helpers.funcs.TypedFunctionBase.new","jmSubLibs/genLIB/decoupledLIB/helpers/funcs/TypedFunctionBase.hx",23,0x0048c4ac)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
	this->b = false;
...
{
		HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.funcs.TypedFunctionBase","checkString",0xe3e08ee0,"jmSubLibs.genLIB.decoupledLIB.helpers.funcs.TypedFunctionBase.checkString","jmSubLibs/genLIB/decoupledLIB/helpers/funcs/TypedFunctionBase.hx",34,0x0048c4ac)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.funcs.TypedFunctionBase"), hx::TCanCast< TypedFunctionBase_obj> ,sStaticFields,sMemberFields,
