...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.consts.openfl.geom.PointZZ","new",0x28ca3235,"jmSubLibs.genLIB.decoupledLIB.helpers.data.consts.openfl.geom.PointZZ.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/consts/openfl/geom/PointZZ.hx",14,0xba7330bd)
HX_STACK_THIS(this)
{
}
;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.consts.openfl.geom.PointZZ"), hx::TCanCast< PointZZ_obj> ,sStaticFields,sMemberFields,
