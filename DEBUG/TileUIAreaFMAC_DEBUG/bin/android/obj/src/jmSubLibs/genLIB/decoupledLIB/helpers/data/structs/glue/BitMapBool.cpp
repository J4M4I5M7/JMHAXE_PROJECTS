...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool","new",0xe6da7f8f,"jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/structs/glue/BitMapBool.hx",23,0xebb7b300)
HX_STACK_THIS(this)
{
}
;
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool"), hx::TCanCast< BitMapBool_obj> ,sStaticFields,sMemberFields,
