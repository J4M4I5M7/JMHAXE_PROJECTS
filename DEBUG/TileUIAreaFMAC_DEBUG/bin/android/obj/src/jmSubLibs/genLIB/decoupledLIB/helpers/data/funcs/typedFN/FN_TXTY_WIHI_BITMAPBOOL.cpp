...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_TXTY_WIHI_BITMAPBOOL","new",0x2ef64198,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_TXTY_WIHI_BITMAPBOOL.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_TXTY_WIHI_BITMAPBOOL.hx",18,0x7acab939)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(18)
	super::__construct();
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL FN_TXTY_WIHI_BITMAPBOOL_obj::make( Dynamic inFunc,::String inName){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_TXTY_WIHI_BITMAPBOOL","make",0xe7d6d9b6,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_TXTY_WIHI_BITMAPBOOL.make","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_TXTY_WIHI_BITMAPBOOL.hx",24,0x7acab939)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_LINE(27)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL op = ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL_obj::__new();		HX_STACK_VAR(op,"op");
	HX_STACK_LINE(30)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL_obj::init(inFunc,inName,op);
	HX_STACK_LINE(31)
	return op;
}
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL FN_TXTY_WIHI_BITMAPBOOL_obj::init( Dynamic inFunc,::String inName,::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_TXTY_WIHI_BITMAPBOOL op){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_TXTY_WIHI_BITMAPBOOL","init",0xe53bdad8,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_TXTY_WIHI_BITMAPBOOL.init","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_TXTY_WIHI_BITMAPBOOL.hx",39,0x7acab939)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_ARG(op,"op")
	HX_STACK_LINE(40)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_TXTY_WIHI_BITMAPBOOL"), hx::TCanCast< FN_TXTY_WIHI_BITMAPBOOL_obj> ,sStaticFields,sMemberFields,
