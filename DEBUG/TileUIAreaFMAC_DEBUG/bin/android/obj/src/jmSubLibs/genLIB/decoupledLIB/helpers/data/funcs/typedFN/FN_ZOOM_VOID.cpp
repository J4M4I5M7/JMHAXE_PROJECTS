...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_ZOOM_VOID","new",0xa0169e3b,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_ZOOM_VOID.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_ZOOM_VOID.hx",8,0x125a5394)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(8)
	super::__construct();
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID FN_ZOOM_VOID_obj::make( Dynamic inFunc,::String inName){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_ZOOM_VOID","make",0x73078bb3,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_ZOOM_VOID.make","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_ZOOM_VOID.hx",14,0x125a5394)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_LINE(16)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID op = ::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID_obj::__new();		HX_STACK_VAR(op,"op");
	HX_STACK_LINE(19)
	::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID_obj::init(inFunc,inName,op);
	HX_STACK_LINE(22)
	return op;
}
...
::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID FN_ZOOM_VOID_obj::init( Dynamic inFunc,::String inName,::jmSubLibs::genLIB::decoupledLIB::helpers::data::funcs::typedFN::FN_ZOOM_VOID op){
	HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_ZOOM_VOID","init",0x706c8cd5,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_ZOOM_VOID.init","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/typedFN/FN_ZOOM_VOID.hx",28,0x125a5394)
	HX_STACK_ARG(inFunc,"inFunc")
	HX_STACK_ARG(inName,"inName")
	HX_STACK_ARG(op,"op")
	HX_STACK_LINE(29)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.typedFN.FN_ZOOM_VOID"), hx::TCanCast< FN_ZOOM_VOID_obj> ,sStaticFields,sMemberFields,
