...
{
HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.TypedFunctionBase","new",0x0fd6efe1,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.TypedFunctionBase.new","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/TypedFunctionBase.hx",23,0x3dbc31cf)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
	this->b = false;
...
{
		HX_STACK_FRAME("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.TypedFunctionBase","checkString",0x4522043a,"jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.TypedFunctionBase.checkString","jmSubLibs/genLIB/decoupledLIB/helpers/data/funcs/TypedFunctionBase.hx",34,0x3dbc31cf)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("jmSubLibs.genLIB.decoupledLIB.helpers.data.funcs.TypedFunctionBase"), hx::TCanCast< TypedFunctionBase_obj> ,sStaticFields,sMemberFields,
