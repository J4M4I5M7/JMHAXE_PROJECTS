...
int inCol = __o_inCol.Default(0);
{
	...
	HX_STACK_LINE(26)
	::openfl::text::TextFormat _g = ::openfl::text::TextFormat_obj::__new(HX_CSTRING("_sans"),(int)12,inCol,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(26)
	...
	HX_STACK_LINE(31)
	this->addEventListener(::openfl::events::Event_obj::ENTER_FRAME,this->onEnter_dyn(),null(),null(),null());
	HX_STACK_LINE(32)
...
Void FPS_Mem_obj::onEnter( ::openfl::events::Event evt){
{
		HX_STACK_FRAME("com.kircode.debug.FPS_Mem","onEnter",0x2f570655,"com.kircode.debug.FPS_Mem.onEnter","com/kircode/debug/FPS_Mem.hx",39,0x8e60c5f7)
		HX_STACK_THIS(this)
