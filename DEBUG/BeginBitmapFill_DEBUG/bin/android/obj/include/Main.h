...
class HXCPP_CLASS_ATTRIBUTES  Main_obj : public ::openfl::display::Sprite_obj{
	...
	public:
		...
		int _sWID;
		int _sHIG;
		::jmSubLibs::genLIB::decoupledLIB::helpers::data::structs::glue::BitMapBool _bm;
		::openfl::display::Sprite _s;
		::jmSubLibs::genLIB::decoupledLIB::systems::decoupled::tileBased::updater::tmrMGR::debug::TileMapUpdateMGR_Debugger _d;
		::jmSubLibs::genLIB::freeBinaryLIB::structs::glue::IntString _ft;
		::com::kircode::debug::FPS_Mem _fps;
		bool _doOnce;
		::openfl::display::BitmapData _bm0;
		::openfl::display::BitmapData _bm1;
