...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("JMIM", "BeginBitmapFillDEBUG", "com.BeginBitmapFillDEBUG", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "BeginBitmapFill_DEBUG", null, { width: 0, height: 0 });
