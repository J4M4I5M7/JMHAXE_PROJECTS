...
Main.prototype = $extend(openfl.display.Sprite.prototype,{
	...
	,init: function() {
		...
		this.inited = true;
		this._sWID = jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelWid();
		this._sHIG = jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelHig();
		this._tWX = 32;
		this._tHY = 32;
		this._d = new jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger();
		this._s = new openfl.display.Sprite();
		this._bm = this._d.getTileBMFunc(0,0,32,32);
		this._ft = new jmSubLibs.genLIB.freeBinaryLIB.structs.glue.IntString();
		this._d.linkSharedFrameTimeTracker(this._ft);
		if(this._bm.map.width != this._tWX) jmSubLibs.EU.msg("wafd");
		if(this._bm.map.height != this._tHY) jmSubLibs.EU.msg("sfdfd");
		this.addChild(this._s);
		this.addEventListener(openfl.events.Event.ENTER_FRAME,$bind(this,this.onEnterFrame));
		this._fps = new com.kircode.debug.FPS_Mem();
		this.addChild(this._fps);
	}
	,onEnterFrame: function(evt) {
		this._ft.i++;
		this._d.getTileFrameID(0,0);
		this._bm = this._d.getTileBMFunc(0,0,this._tWX,this._tHY);
		this._bm.map.unlock();
		this._s.get_graphics().clear();
		this._s.get_graphics().beginBitmapFill(this._bm.map,null,true);
		this._s.get_graphics().drawRect(0,0,this._sWID,this._sHIG);
...
com.kircode = {};
com.kircode.debug = {};
com.kircode.debug.FPS_Mem = function(inX,inY,inCol) {
	...
	this.set_defaultTextFormat(new openfl.text.TextFormat("_sans",12,inCol));
	this.set_text("FPS: ");
	this.times = [];
	this.addEventListener(openfl.events.Event.ENTER_FRAME,$bind(this,this.onEnter));
	this.set_width(150);
	this.set_height(70);
};
$hxClasses["com.kircode.debug.FPS_Mem"] = com.kircode.debug.FPS_Mem;
com.kircode.debug.FPS_Mem.__name__ = ["com","kircode","debug","FPS_Mem"];
com.kircode.debug.FPS_Mem.__super__ = openfl.text.TextField;
com.kircode.debug.FPS_Mem.prototype = $extend(openfl.text.TextField.prototype,{
	...
	,__class__: com.kircode.debug.FPS_Mem
});
var haxe = {};
...
var jmSubLibs = {};
jmSubLibs.EU = function() {
	throw "do not instantiate EU.hx";
};
$hxClasses["jmSubLibs.EU"] = jmSubLibs.EU;
jmSubLibs.EU.__name__ = ["jmSubLibs","EU"];
jmSubLibs.EU.msg = function(inMSG) {
	if(jmSubLibs.EU._configToCrash) throw inMSG; else throw inMSG;
};
jmSubLibs.EU.sid = function(inSTR,inFrom) {
	if(inFrom == null) inFrom = "NOT_SET";
	if(null == inSTR) jmSubLibs.EU.msg("EU.sid::String is null! From:[" + inFrom + "]");
	if("" == inSTR) jmSubLibs.EU.msg("EU.sid::EMPTY STRING! From:[" + inFrom + "]");
};
jmSubLibs.EU.prototype = {
	__class__: jmSubLibs.EU
};
jmSubLibs.expLIB = {};
jmSubLibs.expLIB.haxePhoneLIB = {};
jmSubLibs.expLIB.haxePhoneLIB.staticUtils = {};
jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil = function() {
};
$hxClasses["jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil"] = jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil;
jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.__name__ = ["jmSubLibs","expLIB","haxePhoneLIB","staticUtils","ScreenSizeUtil"];
jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelWid = function() {
	var op = openfl.Lib.current.stage.stageWidth;
	return op;
};
jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelHig = function() {
	var op = openfl.Lib.current.stage.stageHeight;
	return op;
};
jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.debugVisualTest = function(inMain) {
	var w = jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelWid();
	var h = jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.getPixelHig();
	var buf = new openfl.display.BitmapData(w,h,true,-65536);
	jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient(buf,-65536,-16711936,true);
	var buf_vis = new openfl.display.Bitmap();
	buf_vis.bitmapData = buf;
	inMain.addChild(buf_vis);
};
jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil.prototype = {
	__class__: jmSubLibs.expLIB.haxePhoneLIB.staticUtils.ScreenSizeUtil
};
jmSubLibs.genLIB = {};
jmSubLibs.genLIB.decoupledLIB = {};
jmSubLibs.genLIB.decoupledLIB.helpers = {};
jmSubLibs.genLIB.decoupledLIB.helpers.data = {};
jmSubLibs.genLIB.decoupledLIB.helpers.data.structs = {};
jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue = {};
jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool = function() {
};
$hxClasses["jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool"] = jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool;
jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool.__name__ = ["jmSubLibs","genLIB","decoupledLIB","helpers","data","structs","glue","BitMapBool"];
jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool.prototype = {
	__class__: jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool
};
jmSubLibs.genLIB.decoupledLIB.systems = {};
jmSubLibs.genLIB.decoupledLIB.systems.decoupled = {};
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased = {};
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater = {};
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR = {};
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug = {};
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger = function() {
	this._cTileLastUpdateFrame = 0;
	this._opBM_003 = new openfl.display.BitmapData(1,1,true,65535);
	this._opBM_002 = new openfl.display.BitmapData(1,1,true,65535);
	this._opBM_001 = new openfl.display.BitmapData(1,1,true,65535);
	this._opBM = new openfl.display.BitmapData(16,16,true,0);
	this._opBB = new jmSubLibs.genLIB.decoupledLIB.helpers.data.structs.glue.BitMapBool();
	this._opBB.map = this._opBM;
	this._opBB.boo = true;
};
$hxClasses["jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger"] = jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger;
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.__name__ = ["jmSubLibs","genLIB","decoupledLIB","systems","decoupled","tileBased","updater","tmrMGR","debug","TileMapUpdateMGR_Debugger"];
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.remakeBitmapMaybe = function(inBM,inWid,inHig,inFillColor) {
	if(inBM.width != inWid || inBM.height != inHig) {
		inBM.dispose();
		inBM = new openfl.display.BitmapData(inWid,inHig,true,inFillColor);
	}
	return inBM;
};
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.prototype = {
	linkSharedFrameTimeTracker: function(inTT) {
		if(null == inTT) jmSubLibs.EU.msg("linkSharedFrameTimeTracker input null");
		this._frameTracker = inTT;
		this._hasFrameTracker = true;
	}
	,getTileFrameID: function(inTileX,inTileY) {
		var op;
		if(this._hasFrameTracker) {
			if(inTileX == 0 && inTileY == 0) {
				if(0 == this._frameTracker.i % 23) {
					this._cTileLastUpdateFrame = this._frameTracker.i;
					op = this._cTileLastUpdateFrame;
				} else op = this._cTileLastUpdateFrame;
			} else op = 0;
		} else op = 0;
		return op;
	}
	,getTileBMFuncFAST: function(inTileX,inTileY,wid,hig) {
		this._opBM = jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.remakeBitmapMaybe(this._opBM,wid,hig,-16711936);
		this._opBM_001 = jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.remakeBitmapMaybe(this._opBM_001,wid,hig,-65536);
		this._opBM_002 = jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.remakeBitmapMaybe(this._opBM_002,wid,hig,-16711936);
		this._opBM_003 = jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.remakeBitmapMaybe(this._opBM_003,wid,hig,-16776961);
		var c1;
		var c2;
		if(inTileX == 0 && inTileY == 0) {
			var even = 0 == (this._cTileLastUpdateFrame & 1);
			if(even) jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient(this._opBM,-16776961,-16772864,true); else jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient(this._opBM,-65536,-15663104,true);
			this._opBB.map = this._opBM;
		} else if(inTileX == 0 || inTileY == 0) this._opBB.map = this._opBM_001; else {
			var flip1 = inTileX & 1;
			var flip2 = inTileY & 1;
			var flipSum = flip1 + flip2;
			if(this._hasFrameTracker) flipSum = flipSum + this._frameTracker.i;
			var checker;
			var a = flipSum & 1;
			var aNeg = a < 0;
			var bNeg = 0 < 0;
			if(aNeg != bNeg) checker = aNeg; else checker = a > 0;
			if(checker) this._opBB.map = this._opBM_002; else this._opBB.map = this._opBM_003;
		}
		this._opBB.boo = true;
		return this._opBB;
	}
	,getTileBMFunc: function(inTileX,inTileY,wid,hig) {
		if(jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.useFastBitmapGetterFunc) return this.getTileBMFuncFAST(inTileX,inTileY,wid,hig);
		if(this._opBM.width != wid || this._opBM.height != hig) {
			this._opBM.dispose();
			this._opBM = new openfl.display.BitmapData(wid,hig,true,0);
		}
		var c1;
		var c2;
		if(inTileX == 0 && inTileY == 0) {
			...
			if(aNeg != bNeg) checker = aNeg; else checker = a > 0;
			if(checker) {
				c1 = -16777199 - inTileX * 3;
				c2 = -16776961;
			} else {
				c1 = -16772864;
				c2 = -16711936 * inTileY * 3;
			}
		}
		jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient(this._opBM,c1,c2,true);
		this._opBB.map = this._opBM;
		this._opBB.boo = true;
		return this._opBB;
	}
	,resizeInternalsFunc: function(inWid,inHig) {
	}
	,modelUpdateFunc: function() {
	}
	,__class__: jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger
};
jmSubLibs.genLIB.decoupledLIB.utils = {};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils = {};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics = {};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap = {};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill = {};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil = function() {
};
$hxClasses["jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil"] = jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil;
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.__name__ = ["jmSubLibs","genLIB","decoupledLIB","utils","staticUtils","graphics","bitmap","fill","BitmapFillPatternUtil"];
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.makeRectangularGradient = function(inBm,centerColor,edgeColor,clearBitmapFirst) {
	if(clearBitmapFirst == null) clearBitmapFirst = true;
	jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.func(inBm,centerColor,edgeColor,clearBitmapFirst);
};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil.prototype = {
	__class__: jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.BitmapFillPatternUtil
};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs = {};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient = function() {
};
$hxClasses["jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient"] = jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient;
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.__name__ = ["jmSubLibs","genLIB","decoupledLIB","utils","staticUtils","graphics","bitmap","fill","funcs","BFPU_MakeRectangularGradient"];
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.func = function(inBm,centerColor,edgeColor,clearBitmapFirst) {
	if(clearBitmapFirst == null) clearBitmapFirst = true;
	if(clearBitmapFirst) inBm.fillRect(inBm.rect,0);
	var a0 = 255 & centerColor >> 24;
	var r0 = 255 & centerColor >> 16;
	var g0 = 255 & centerColor >> 8;
	var b0 = 255 & centerColor;
	var a1 = 255 & edgeColor >> 24;
	var r1 = 255 & edgeColor >> 16;
	var g1 = 255 & edgeColor >> 8;
	var b1 = 255 & edgeColor;
	var newColor;
	var aN;
	var rN;
	var gN;
	...
	var y0 = 0;
	var x1 = inBm.width - 1;
	var y1 = inBm.height - 1;
	var cenX = (x0 + x1) * 0.5 | 0;
	var cenY = (y0 + y1) * 0.5 | 0;
	var inX0 = 0 - (x0 - cenX);
	var inY0 = 0 - (y0 - cenY);
	var inX1 = x1 - cenX;
	var inY1 = y1 - cenY;
	...
	while(sx <= x1) {
		...
		while(sy <= y1) {
			...
			if(xNeg) deltaPerX = deltaX / inX0; else deltaPerX = deltaX / inX1;
			if(yNeg) deltaPerY = deltaY / inY0; else deltaPerY = deltaY / inY1;
			if(deltaPerX > deltaPerY) maxPer = 1 - deltaPerX; else maxPer = 1 - deltaPerY;
			var invPer = 1 - maxPer;
			aN = ((function($this) {
				var $r;
				var $int = a0;
			...
			newColor = aN << 24 | rN << 16 | gN << 8 | bN;
			inBm.setPixel32(sx,sy,newColor);
		}
	}
};
jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient.prototype = {
	__class__: jmSubLibs.genLIB.decoupledLIB.utils.staticUtils.graphics.bitmap.fill.funcs.BFPU_MakeRectangularGradient
};
jmSubLibs.genLIB.freeBinaryLIB = {};
jmSubLibs.genLIB.freeBinaryLIB.structs = {};
jmSubLibs.genLIB.freeBinaryLIB.structs.glue = {};
jmSubLibs.genLIB.freeBinaryLIB.structs.glue.IntString = function() {
};
$hxClasses["jmSubLibs.genLIB.freeBinaryLIB.structs.glue.IntString"] = jmSubLibs.genLIB.freeBinaryLIB.structs.glue.IntString;
jmSubLibs.genLIB.freeBinaryLIB.structs.glue.IntString.__name__ = ["jmSubLibs","genLIB","freeBinaryLIB","structs","glue","IntString"];
jmSubLibs.genLIB.freeBinaryLIB.structs.glue.IntString.prototype = {
	__class__: jmSubLibs.genLIB.freeBinaryLIB.structs.glue.IntString
};
var js = {};
js.Boot = function() { };
...
jmSubLibs.EU._configToCrash = true;
jmSubLibs.genLIB.decoupledLIB.systems.decoupled.tileBased.updater.tmrMGR.debug.TileMapUpdateMGR_Debugger.useFastBitmapGetterFunc = true;
